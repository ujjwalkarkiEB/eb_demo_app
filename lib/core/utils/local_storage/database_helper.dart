...
class DatabaseHelper {
  Future<void> initializeLocalDatabase() async {
    ...
    Hive.registerAdapter(NotificationBadgeModelAdapter());
    ...
    await Hive.openBox<NotificationBadgeModel>(notificationBadgeBoxName);
  }
  ...
  Box<NotificationBadgeModel> get notificationBadgeBox =>
      Hive.box(notificationBadgeBoxName);
}
