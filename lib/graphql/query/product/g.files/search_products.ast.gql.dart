...
const searchProducts = _i1.OperationDefinitionNode(
  ...
  variableDefinitions: [
    ...
    _i1.VariableDefinitionNode(
      variable: _i1.VariableNode(name: _i1.NameNode(value: 'price_min')),
      type: _i1.NamedTypeNode(
    ...
    _i1.VariableDefinitionNode(
      variable: _i1.VariableNode(name: _i1.NameNode(value: 'price_max')),
      type: _i1.NamedTypeNode(
        name: _i1.NameNode(value: 'Int'),
        isNonNull: false,
      ),
    ...
    _i1.FieldNode(
      ...
      arguments: [
        ...
        _i1.ArgumentNode(
          ...
          value: _i1.VariableNode(name: _i1.NameNode(value: 'price_min')),
        ),
        _i1.ArgumentNode(
          name: _i1.NameNode(value: 'price_max'),
          value: _i1.VariableNode(name: _i1.NameNode(value: 'price_max')),
        ),
        _i1.ArgumentNode(
