...
part of 'search_products.req.gql.dart';
...
class _$GsearchProductsReqSerializer
  ...
  Iterable<Object?> serialize(
      Serializers serializers, GsearchProductsReq object,
...
class _$GsearchProductsReq extends GsearchProductsReq {
  ...
  factory _$GsearchProductsReq(
      ...
      (new GsearchProductsReqBuilder()..update(updates))._build();
  ...
  _$GsearchProductsReq._(
      ...
      this.context})
      : super._() {
    BuiltValueNullFieldError.checkNotNull(vars, r'GsearchProductsReq', 'vars');
    BuiltValueNullFieldError.checkNotNull(
        operation, r'GsearchProductsReq', 'operation');
    BuiltValueNullFieldError.checkNotNull(
        executeOnListen, r'GsearchProductsReq', 'executeOnListen');
  }
  ...
  @override
  String toString() {
    return (newBuiltValueToStringHelper(r'GsearchProductsReq')
          ..add('vars', vars)
...
class GsearchProductsReqBuilder
  ...
  @override
  GsearchProductsReq build() => _build();

  _$GsearchProductsReq _build() {
    ...
    try {
      ...
      try {
        ...
        throw new BuiltValueNestedFieldError(
            r'GsearchProductsReq', _$failedField, e.toString());
      }
      rethrow;
    }
    replace(_$result);
